# Runtime Tcl commands to interact with - efi_axi_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/efi_axi_v1_0_include.tcl
...
# Test: OUT_AXI
# Create a write transaction at out_axi_addr address
create_hw_axi_txn w_out_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $out_axi_addr -data $wdata_1
# Create a read transaction at out_axi_addr address
create_hw_axi_txn r_out_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $out_axi_addr
# Initiate transactions
run_hw_axi r_out_axi_addr
run_hw_axi w_out_axi_addr
run_hw_axi r_out_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_out_axi_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - OUT_AXI"
} else {
	puts "Data comparison test fail for - OUT_AXI, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
...
# Test: IN_AXI
set wdata_in_axi [get_init_data 0]
create_hw_axi_txn w_in_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_in_axi}
create_hw_axi_txn r_in_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_in_axi_addr
run_hw_axi w_in_axi_addr
run_hw_axi r_in_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_in_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - IN_AXI"
} else {
	puts "Data comparison test fail for - IN_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
