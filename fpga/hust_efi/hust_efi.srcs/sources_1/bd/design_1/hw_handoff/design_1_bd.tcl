...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ckp [ create_bd_port -dir I -type data ckp ]
  set ckp_tb [ create_bd_port -dir O -from 0 -to 0 -type data ckp_tb ]
  set efi_on [ create_bd_port -dir I -type data efi_on ]
  set fuel_pump [ create_bd_port -dir O -from 3 -to 0 fuel_pump ]
  set ignite [ create_bd_port -dir O -from 3 -to 0 ignite ]
  set inject [ create_bd_port -dir O -from 3 -to 0 -type data inject ]
  ...
  # Create instance: efi_virtual_input_0, and set properties
  set efi_virtual_input_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:efi_virtual_input:1.0 efi_virtual_input_0 ]

  # Create instance: hust_efi_0, and set properties
  set block_name hust_efi
  set block_cell_name hust_efi_0
  if { [catch {set hust_efi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $hust_efi_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {2.500000} \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {2.5} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins efi_virtual_input_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_gpio_3/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_5/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_6/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_gpio_7/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_8/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins axi_gpio_9/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports ckp_tb] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins hust_efi_0/done]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins hust_efi_0/btdc_ready]
  connect_bd_net -net ckp_1 [get_bd_ports ckp] [get_bd_pins hust_efi_0/ckp]
  connect_bd_net -net efi_on_1 [get_bd_ports efi_on] [get_bd_pins hust_efi_0/efi_on]
  connect_bd_net -net hust_efi_0_cal_btdc [get_bd_pins axi_gpio_6/gpio_io_i] [get_bd_pins hust_efi_0/cal_btdc]
  connect_bd_net -net hust_efi_0_cal_ignition [get_bd_pins axi_gpio_8/gpio_io_i] [get_bd_pins hust_efi_0/cal_ignition]
  connect_bd_net -net hust_efi_0_cal_injection [get_bd_pins axi_gpio_7/gpio_io_i] [get_bd_pins hust_efi_0/cal_injection]
  connect_bd_net -net hust_efi_0_cal_rpm [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins hust_efi_0/cal_rpm]
  connect_bd_net -net hust_efi_0_crank_counter [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins hust_efi_0/crank_counter]
  connect_bd_net -net hust_efi_0_crank_cycle_counter [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins hust_efi_0/crank_cycle_counter]
  connect_bd_net -net hust_efi_0_fuel_pump [get_bd_ports fuel_pump] [get_bd_pins hust_efi_0/fuel_pump]
  connect_bd_net -net hust_efi_0_ignite [get_bd_ports ignite] [get_bd_pins hust_efi_0/ignite]
  connect_bd_net -net hust_efi_0_inject [get_bd_ports inject] [get_bd_pins hust_efi_0/inject]
  connect_bd_net -net hust_efi_0_update_table [get_bd_pins axi_gpio_9/gpio_io_i] [get_bd_pins hust_efi_0/update_table]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins axi_gpio_8/s_axi_aclk] [get_bd_pins axi_gpio_9/s_axi_aclk] [get_bd_pins efi_virtual_input_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins hust_efi_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins axi_gpio_7/s_axi_aresetn] [get_bd_pins axi_gpio_8/s_axi_aresetn] [get_bd_pins axi_gpio_9/s_axi_aresetn] [get_bd_pins efi_virtual_input_0/s00_axi_aresetn] [get_bd_pins hust_efi_0/reset_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs efi_virtual_input_0/S00_AXI/S00_AXI_reg] SEG_efi_virtual_input_0_S00_AXI_reg
