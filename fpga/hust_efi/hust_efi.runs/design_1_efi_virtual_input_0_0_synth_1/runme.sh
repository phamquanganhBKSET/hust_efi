...
HD_PWD='C:/Users/HH/Documents/Embedded_system/hust_efi/fpga/hust_efi/hust_efi.runs/design_1_efi_virtual_input_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_efi_virtual_input_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_efi_virtual_input_0_0.tcl
